...
//ol.proj.get("EPSG:7844").setExtent([143.699685, -37.613058, 143.882665, -37.474703]);
var wms_layers = [];
...
var format_Waterwaysbuffered_39 = new ol.format.GeoJSON();
var features_Waterwaysbuffered_39 = format_Waterwaysbuffered_39.readFeatures(json_Waterwaysbuffered_39, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7844'});
var jsonSource_Waterwaysbuffered_39 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Waterwaysbuffered_39.addFeatures(features_Waterwaysbuffered_39);
var lyr_Waterwaysbuffered_39 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Waterwaysbuffered_39, 
                style: style_Waterwaysbuffered_39,
                popuplayertitle: "Waterways buffered",
                interactive: false,
                title: '<img src="styles/legend/Waterwaysbuffered_39.png" /> Waterways buffered'
            });
...
var format_Parcel_57 = new ol.format.GeoJSON();
var features_Parcel_57 = format_Parcel_57.readFeatures(json_Parcel_57, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7844'});
var jsonSource_Parcel_57 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Parcel_57.addFeatures(features_Parcel_57);
var lyr_Parcel_57 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Parcel_57, 
                style: style_Parcel_57,
                popuplayertitle: "Parcel",
                interactive: true,
                title: '<img src="styles/legend/Parcel_57.png" /> Parcel'
            });
var format_Zoned10ha_58 = new ol.format.GeoJSON();
var features_Zoned10ha_58 = format_Zoned10ha_58.readFeatures(json_Zoned10ha_58, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7844'});
var jsonSource_Zoned10ha_58 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Zoned10ha_58.addFeatures(features_Zoned10ha_58);
var lyr_Zoned10ha_58 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Zoned10ha_58, 
                style: style_Zoned10ha_58,
                popuplayertitle: "Zoned>10ha",
                interactive: true,
                title: '<img src="styles/legend/Zoned10ha_58.png" /> Zoned>10ha'
            });
var format_MinersRestTownshipPlan_59 = new ol.format.GeoJSON();
var features_MinersRestTownshipPlan_59 = format_MinersRestTownshipPlan_59.readFeatures(json_MinersRestTownshipPlan_59, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7844'});
var jsonSource_MinersRestTownshipPlan_59 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MinersRestTownshipPlan_59.addFeatures(features_MinersRestTownshipPlan_59);
var lyr_MinersRestTownshipPlan_59 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MinersRestTownshipPlan_59, 
                style: style_MinersRestTownshipPlan_59,
                popuplayertitle: "Miners Rest Township Plan",
                interactive: false,
                title: '<img src="styles/legend/MinersRestTownshipPlan_59.png" /> Miners Rest Township Plan'
            });
...
var format_BallaratNorthPSPBoundary_61 = new ol.format.GeoJSON();
var features_BallaratNorthPSPBoundary_61 = format_BallaratNorthPSPBoundary_61.readFeatures(json_BallaratNorthPSPBoundary_61, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7844'});
var jsonSource_BallaratNorthPSPBoundary_61 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BallaratNorthPSPBoundary_61.addFeatures(features_BallaratNorthPSPBoundary_61);
var lyr_BallaratNorthPSPBoundary_61 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_BallaratNorthPSPBoundary_61, 
                style: style_BallaratNorthPSPBoundary_61,
                popuplayertitle: "Ballarat North PSP Boundary",
                interactive: false,
                title: '<img src="styles/legend/BallaratNorthPSPBoundary_61.png" /> Ballarat North PSP Boundary'
            });
var format_BallaratNorthWesternGrowthArea_62 = new ol.format.GeoJSON();
var features_BallaratNorthWesternGrowthArea_62 = format_BallaratNorthWesternGrowthArea_62.readFeatures(json_BallaratNorthWesternGrowthArea_62, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7844'});
var jsonSource_BallaratNorthWesternGrowthArea_62 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BallaratNorthWesternGrowthArea_62.addFeatures(features_BallaratNorthWesternGrowthArea_62);
var lyr_BallaratNorthWesternGrowthArea_62 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_BallaratNorthWesternGrowthArea_62, 
                style: style_BallaratNorthWesternGrowthArea_62,
                popuplayertitle: "Ballarat North Western Growth Area",
                interactive: false,
                title: '<img src="styles/legend/BallaratNorthWesternGrowthArea_62.png" /> Ballarat North Western Growth Area'
            });
var group_PSPGrowthArea = new ol.layer.Group({
                                layers: [lyr_MinersRestTownshipPlan_59,lyr_BallaratWestPSPBoundary_60,lyr_BallaratNorthPSPBoundary_61,lyr_BallaratNorthWesternGrowthArea_62,],
                                fold: "open",
                                title: "PSP/ Growth Area"});
var group_Administrative = new ol.layer.Group({
                                layers: [lyr_Suburb_55,lyr_LGA_56,lyr_Parcel_57,lyr_Zoned10ha_58,],
                                fold: "open",
...
var group_DeductOverlays = new ol.layer.Group({
                                layers: [lyr_Waterwaysbuffered_39,lyr_FOFloodwayOverlay_40,lyr_HeritageRegister_41,lyr_HOHeritageOverlay_42,lyr_LSIOLandSubjecttoInundationOverlay_43,lyr_VPOVegetationProtectionOverlay_44,],
                                fold: "open",
...
lyr_Waterwaysbuffered_39.set('fieldAliases', {'fid': 'fid', 'id': 'id', 'layer': 'layer', 'path': 'path', });
...
lyr_Parcel_57.set('fieldAliases', {'fid': 'fid', 'OBJECTID': 'OBJECTID', 'PARCEL_PFI': 'PARCEL_PFI', 'PARCEL_SPI': 'PARCEL_SPI', 'PARCEL_SPI_CODE': 'PARCEL_SPI_CODE', 'PARCEL_DESC_TYPE': 'PARCEL_DESC_TYPE', 'PARCEL_MULTI': 'PARCEL_MULTI', 'PARCEL_ROAD': 'PARCEL_ROAD', 'PARCEL_LGA_CODE': 'PARCEL_LGA_CODE', 'PARCEL_PLAN_NUMBER': 'PARCEL_PLAN_NUMBER', 'PARCEL_LOT_NUMBER': 'PARCEL_LOT_NUMBER', 'PARCEL_ACCESSORY_LOT': 'PARCEL_ACCESSORY_LOT', 'PARCEL_ALLOTMENT': 'PARCEL_ALLOTMENT', 'PARCEL_SEC': 'PARCEL_SEC', 'PARCEL_BLOCK': 'PARCEL_BLOCK', 'PARCEL_PORTION': 'PARCEL_PORTION', 'PARCEL_SUBDIVISION': 'PARCEL_SUBDIVISION', 'PARCEL_CROWN_STATUS': 'PARCEL_CROWN_STATUS', 'PARCEL_PARISH_CODE': 'PARCEL_PARISH_CODE', 'PARCEL_TOWNSHIP_CODE': 'PARCEL_TOWNSHIP_CODE', 'PARCEL_P_NUMBER': 'PARCEL_P_NUMBER', 'PARCEL_FURTHER_DESCRIPTION': 'PARCEL_FURTHER_DESCRIPTION', 'PARCEL_PART': 'PARCEL_PART', 'PARCEL_STATUS': 'PARCEL_STATUS', 'PARCEL_REG_DATE': 'PARCEL_REG_DATE', 'PARCEL_ID': 'PARCEL_ID', 'PARCEL_PFI_CREATED': 'PARCEL_PFI_CREATED', 'PARCEL_UFI': 'PARCEL_UFI', 'PARCEL_UFI_CREATED': 'PARCEL_UFI_CREATED', 'PARCEL_UFI_OLD': 'PARCEL_UFI_OLD', 'PARCEL_TASK_ID': 'PARCEL_TASK_ID', 'PARV_HORIZ_POS_UNCERTAINTY': 'PARV_HORIZ_POS_UNCERTAINTY', 'PARV_UFI': 'PARV_UFI', 'PARV_UFI_OLD': 'PARV_UFI_OLD', 'PARV_TASK_ID': 'PARV_TASK_ID', 'VDPID': 'VDPID', 'Shape_Length': 'Shape_Length', 'Shape_Area': 'Shape_Area', 'Gross Ha': 'Gross Ha', 'EZI_ADDRESS': 'EZI_ADDRESS', });
lyr_Zoned10ha_58.set('fieldAliases', {'fid': 'fid', 'PARCEL_PFI': 'PARCEL_PFI', 'PARCEL_SPI': 'PARCEL_SPI', 'PC_PLANNO': 'PC_PLANNO', 'PC_LOTNO': 'PC_LOTNO', 'Gross HA': 'Gross HA', 'OBJECTID': 'OBJECTID', 'LGA': 'LGA', 'ZONE_CODE': 'ZONE_CODE', 'Zone 1 Ha': 'Zone 1 Ha', 'SAL_NAME21': 'SAL_NAME21', 'Address': 'Address', 'Address.': 'Address.', 'fid_2': 'fid_2', 'OBJECTID_2': 'OBJECTID_2', 'PROPERTY_PFI': 'PROPERTY_PFI', 'EZI_ADDRESS': 'EZI_ADDRESS', 'PROPERTY_STATUS': 'PROPERTY_STATUS', 'BLG_UNIT_TYPE': 'BLG_UNIT_TYPE', 'HSA_FLAG': 'HSA_FLAG', 'HSA_UNIT_ID': 'HSA_UNIT_ID', 'BLG_UNIT_PREFIX_1': 'BLG_UNIT_PREFIX_1', 'BLG_UNIT_ID_1': 'BLG_UNIT_ID_1', 'BLG_UNIT_SUFFIX_1': 'BLG_UNIT_SUFFIX_1', 'BLG_UNIT_PREFIX_2': 'BLG_UNIT_PREFIX_2', 'BLG_UNIT_ID_2': 'BLG_UNIT_ID_2', 'BLG_UNIT_SUFFIX_2': 'BLG_UNIT_SUFFIX_2', 'FLOOR_TYPE': 'FLOOR_TYPE', 'FLOOR_PREFIX_1': 'FLOOR_PREFIX_1', 'FLOOR_NO_1': 'FLOOR_NO_1', 'FLOOR_SUFFIX_1': 'FLOOR_SUFFIX_1', 'FLOOR_PREFIX_2': 'FLOOR_PREFIX_2', 'FLOOR_NO_2': 'FLOOR_NO_2', 'FLOOR_SUFFIX_2': 'FLOOR_SUFFIX_2', 'HOUSE_PREFIX_1': 'HOUSE_PREFIX_1', 'HOUSE_NUMBER_1': 'HOUSE_NUMBER_1', 'HOUSE_SUFFIX_1': 'HOUSE_SUFFIX_1', 'HOUSE_PREFIX_2': 'HOUSE_PREFIX_2', 'HOUSE_NUMBER_2': 'HOUSE_NUMBER_2', 'HOUSE_SUFFIX_2': 'HOUSE_SUFFIX_2', 'DISP_PREFIX_1': 'DISP_PREFIX_1', 'DISP_NUMBER_1': 'DISP_NUMBER_1', 'DISP_SUFFIX_1': 'DISP_SUFFIX_1', 'DISP_PREFIX_2': 'DISP_PREFIX_2', 'DISP_NUMBER_2': 'DISP_NUMBER_2', 'DISP_SUFFIX_2': 'DISP_SUFFIX_2', 'ROAD_NAME': 'ROAD_NAME', 'ROAD_TYPE': 'ROAD_TYPE', 'ROAD_SUFFIX': 'ROAD_SUFFIX', 'LOCALITY_NAME': 'LOCALITY_NAME', 'LGA_CODE': 'LGA_CODE', 'STATE': 'STATE', 'POSTCODE': 'POSTCODE', 'NUM_ROAD_ADDRESS': 'NUM_ROAD_ADDRESS', 'COMPLEX_SITE': 'COMPLEX_SITE', 'TASK_ID': 'TASK_ID', 'NDH (ovl)': 'NDH (ovl)', 'P_Lot size': 'P_Lot size', 'Lead Link': 'Lead Link', 'Land Owner': 'Land Owner', 'Contact no:': 'Contact no:', 'Email': 'Email', });
lyr_MinersRestTownshipPlan_59.set('fieldAliases', {'id': 'id', });
lyr_BallaratWestPSPBoundary_60.set('fieldAliases', {'id': 'id', });
lyr_BallaratNorthPSPBoundary_61.set('fieldAliases', {'id': 'id', });
lyr_BallaratNorthWesternGrowthArea_62.set('fieldAliases', {'id': 'id', });
...
lyr_Waterwaysbuffered_39.set('fieldImages', {'fid': 'TextEdit', 'id': 'TextEdit', 'layer': 'TextEdit', 'path': 'TextEdit', });
...
lyr_BAOBufferAreaOverlay_45.set('fieldImages', {'fid': '', 'OBJECTID': '', 'PFI': '', 'SCHEME_COD': '', 'LGA_CODE': '', 'LGA': '', 'ZONE_NUM': '', 'ZONE_STATU': '', 'ZONE_CODE': '', 'ZONE_DESCR': '', 'GAZ_BEGIN_': '', 'PFI_CREATE': '', 'UFI': '', 'UFI_CREATE': '', 'ZONE_CODE_': '', 'ZONE_COD_1': '', 'Shape_Leng': '', 'Shape_Area': '', });
lyr_BMOBushfireManagementOverlay_46.set('fieldImages', {'fid': '', 'OBJECTID': '', 'PFI': '', 'SCHEME_COD': '', 'LGA_CODE': '', 'LGA': '', 'ZONE_NUM': '', 'ZONE_STATU': '', 'ZONE_CODE': '', 'ZONE_DESCR': '', 'GAZ_BEGIN_': '', 'PFI_CREATE': '', 'UFI': '', 'UFI_CREATE': '', 'ZONE_CODE_': '', 'ZONE_COD_1': '', 'Shape_Leng': '', 'Shape_Area': '', });
lyr_ESOEnvironmentalSignificanceOverlay_47.set('fieldImages', {'fid': '', 'OBJECTID': '', 'PFI': '', 'SCHEME_COD': '', 'LGA_CODE': '', 'LGA': '', 'ZONE_NUM': '', 'ZONE_STATU': '', 'ZONE_CODE': '', 'ZONE_DESCR': '', 'GAZ_BEGIN_': '', 'PFI_CREATE': '', 'UFI': '', 'UFI_CREATE': '', 'ZONE_CODE_': '', 'ZONE_COD_1': '', 'Shape_Leng': '', 'Shape_Area': '', });
lyr_PAOPublicAcquisitionOverlay_48.set('fieldImages', {'fid': '', 'OBJECTID': '', 'PFI': '', 'SCHEME_COD': '', 'LGA_CODE': '', 'LGA': '', 'ZONE_NUM': '', 'ZONE_STATU': '', 'ZONE_CODE': '', 'ZONE_DESCR': '', 'GAZ_BEGIN_': '', 'PFI_CREATE': '', 'UFI': '', 'UFI_CREATE': '', 'ZONE_CODE_': '', 'ZONE_COD_1': '', 'Shape_Leng': '', 'Shape_Area': '', });
lyr_RORestructureOverlay_49.set('fieldImages', {'fid': '', 'OBJECTID': '', 'PFI': '', 'SCHEME_COD': '', 'LGA_CODE': '', 'LGA': '', 'ZONE_NUM': '', 'ZONE_STATU': '', 'ZONE_CODE': '', 'ZONE_DESCR': '', 'GAZ_BEGIN_': '', 'PFI_CREATE': '', 'UFI': '', 'UFI_CREATE': '', 'ZONE_CODE_': '', 'ZONE_COD_1': '', 'Shape_Leng': '', 'Shape_Area': '', });
...
lyr_SLOSignificantLandscapeOverlay_51.set('fieldImages', {'fid': '', 'OBJECTID': '', 'PFI': '', 'SCHEME_COD': '', 'LGA_CODE': '', 'LGA': '', 'ZONE_NUM': '', 'ZONE_STATU': '', 'ZONE_CODE': '', 'ZONE_DESCR': '', 'GAZ_BEGIN_': '', 'PFI_CREATE': '', 'UFI': '', 'UFI_CREATE': '', 'ZONE_CODE_': '', 'ZONE_COD_1': '', 'Shape_Leng': '', 'Shape_Area': '', });
lyr_SROStateResourceOverlay_52.set('fieldImages', {'fid': '', 'OBJECTID': '', 'PFI': '', 'SCHEME_COD': '', 'LGA_CODE': '', 'LGA': '', 'ZONE_NUM': '', 'ZONE_STATU': '', 'ZONE_CODE': '', 'ZONE_DESCR': '', 'GAZ_BEGIN_': '', 'PFI_CREATE': '', 'UFI': '', 'UFI_CREATE': '', 'ZONE_CODE_': '', 'ZONE_COD_1': '', 'Shape_Leng': '', 'Shape_Area': '', });
lyr_SteepSlope_53.set('fieldImages', {'fid': '', 'DN': '', });
...
lyr_Parcel_57.set('fieldImages', {'fid': '', 'OBJECTID': '', 'PARCEL_PFI': '', 'PARCEL_SPI': '', 'PARCEL_SPI_CODE': '', 'PARCEL_DESC_TYPE': '', 'PARCEL_MULTI': '', 'PARCEL_ROAD': '', 'PARCEL_LGA_CODE': '', 'PARCEL_PLAN_NUMBER': '', 'PARCEL_LOT_NUMBER': '', 'PARCEL_ACCESSORY_LOT': '', 'PARCEL_ALLOTMENT': '', 'PARCEL_SEC': '', 'PARCEL_BLOCK': '', 'PARCEL_PORTION': '', 'PARCEL_SUBDIVISION': '', 'PARCEL_CROWN_STATUS': '', 'PARCEL_PARISH_CODE': '', 'PARCEL_TOWNSHIP_CODE': '', 'PARCEL_P_NUMBER': '', 'PARCEL_FURTHER_DESCRIPTION': '', 'PARCEL_PART': '', 'PARCEL_STATUS': '', 'PARCEL_REG_DATE': '', 'PARCEL_ID': '', 'PARCEL_PFI_CREATED': '', 'PARCEL_UFI': '', 'PARCEL_UFI_CREATED': '', 'PARCEL_UFI_OLD': '', 'PARCEL_TASK_ID': '', 'PARV_HORIZ_POS_UNCERTAINTY': '', 'PARV_UFI': '', 'PARV_UFI_OLD': '', 'PARV_TASK_ID': '', 'VDPID': '', 'Shape_Length': '', 'Shape_Area': '', 'Gross Ha': '', 'EZI_ADDRESS': '', });
lyr_Zoned10ha_58.set('fieldImages', {'fid': 'TextEdit', 'PARCEL_PFI': 'TextEdit', 'PARCEL_SPI': 'TextEdit', 'PC_PLANNO': 'TextEdit', 'PC_LOTNO': 'TextEdit', 'Gross HA': 'TextEdit', 'OBJECTID': 'TextEdit', 'LGA': 'TextEdit', 'ZONE_CODE': 'TextEdit', 'Zone 1 Ha': 'TextEdit', 'SAL_NAME21': 'TextEdit', 'Address': 'TextEdit', 'Address.': 'TextEdit', 'fid_2': 'TextEdit', 'OBJECTID_2': 'TextEdit', 'PROPERTY_PFI': 'TextEdit', 'EZI_ADDRESS': 'TextEdit', 'PROPERTY_STATUS': 'TextEdit', 'BLG_UNIT_TYPE': 'TextEdit', 'HSA_FLAG': 'TextEdit', 'HSA_UNIT_ID': 'TextEdit', 'BLG_UNIT_PREFIX_1': 'TextEdit', 'BLG_UNIT_ID_1': 'TextEdit', 'BLG_UNIT_SUFFIX_1': 'TextEdit', 'BLG_UNIT_PREFIX_2': 'TextEdit', 'BLG_UNIT_ID_2': 'TextEdit', 'BLG_UNIT_SUFFIX_2': 'TextEdit', 'FLOOR_TYPE': 'TextEdit', 'FLOOR_PREFIX_1': 'TextEdit', 'FLOOR_NO_1': 'TextEdit', 'FLOOR_SUFFIX_1': 'TextEdit', 'FLOOR_PREFIX_2': 'TextEdit', 'FLOOR_NO_2': 'TextEdit', 'FLOOR_SUFFIX_2': 'TextEdit', 'HOUSE_PREFIX_1': 'TextEdit', 'HOUSE_NUMBER_1': 'TextEdit', 'HOUSE_SUFFIX_1': 'TextEdit', 'HOUSE_PREFIX_2': 'TextEdit', 'HOUSE_NUMBER_2': 'TextEdit', 'HOUSE_SUFFIX_2': 'TextEdit', 'DISP_PREFIX_1': 'TextEdit', 'DISP_NUMBER_1': 'TextEdit', 'DISP_SUFFIX_1': 'TextEdit', 'DISP_PREFIX_2': 'TextEdit', 'DISP_NUMBER_2': 'TextEdit', 'DISP_SUFFIX_2': 'TextEdit', 'ROAD_NAME': 'TextEdit', 'ROAD_TYPE': 'TextEdit', 'ROAD_SUFFIX': 'TextEdit', 'LOCALITY_NAME': 'TextEdit', 'LGA_CODE': 'TextEdit', 'STATE': 'TextEdit', 'POSTCODE': 'TextEdit', 'NUM_ROAD_ADDRESS': 'TextEdit', 'COMPLEX_SITE': 'TextEdit', 'TASK_ID': 'TextEdit', 'NDH (ovl)': 'TextEdit', 'P_Lot size': 'TextEdit', 'Lead Link': 'TextEdit', 'Land Owner': 'TextEdit', 'Contact no:': 'TextEdit', 'Email': 'TextEdit', });
lyr_MinersRestTownshipPlan_59.set('fieldImages', {'id': 'TextEdit', });
lyr_BallaratWestPSPBoundary_60.set('fieldImages', {'id': 'TextEdit', });
lyr_BallaratNorthPSPBoundary_61.set('fieldImages', {'id': '', });
lyr_BallaratNorthWesternGrowthArea_62.set('fieldImages', {'id': '', });
...
lyr_Waterwaysbuffered_39.set('fieldLabels', {'fid': 'hidden field', 'id': 'hidden field', 'layer': 'hidden field', 'path': 'hidden field', });
...
lyr_Parcel_57.set('fieldLabels', {'fid': 'hidden field', 'OBJECTID': 'hidden field', 'PARCEL_PFI': 'hidden field', 'PARCEL_SPI': 'hidden field', 'PARCEL_SPI_CODE': 'hidden field', 'PARCEL_DESC_TYPE': 'hidden field', 'PARCEL_MULTI': 'hidden field', 'PARCEL_ROAD': 'hidden field', 'PARCEL_LGA_CODE': 'hidden field', 'PARCEL_PLAN_NUMBER': 'inline label - always visible', 'PARCEL_LOT_NUMBER': 'inline label - always visible', 'PARCEL_ACCESSORY_LOT': 'hidden field', 'PARCEL_ALLOTMENT': 'hidden field', 'PARCEL_SEC': 'hidden field', 'PARCEL_BLOCK': 'hidden field', 'PARCEL_PORTION': 'hidden field', 'PARCEL_SUBDIVISION': 'hidden field', 'PARCEL_CROWN_STATUS': 'hidden field', 'PARCEL_PARISH_CODE': 'hidden field', 'PARCEL_TOWNSHIP_CODE': 'hidden field', 'PARCEL_P_NUMBER': 'hidden field', 'PARCEL_FURTHER_DESCRIPTION': 'hidden field', 'PARCEL_PART': 'hidden field', 'PARCEL_STATUS': 'hidden field', 'PARCEL_REG_DATE': 'hidden field', 'PARCEL_ID': 'hidden field', 'PARCEL_PFI_CREATED': 'hidden field', 'PARCEL_UFI': 'hidden field', 'PARCEL_UFI_CREATED': 'hidden field', 'PARCEL_UFI_OLD': 'hidden field', 'PARCEL_TASK_ID': 'hidden field', 'PARV_HORIZ_POS_UNCERTAINTY': 'hidden field', 'PARV_UFI': 'hidden field', 'PARV_UFI_OLD': 'hidden field', 'PARV_TASK_ID': 'hidden field', 'VDPID': 'hidden field', 'Shape_Length': 'hidden field', 'Shape_Area': 'hidden field', 'Gross Ha': 'inline label - always visible', 'EZI_ADDRESS': 'inline label - always visible', });
lyr_Zoned10ha_58.set('fieldLabels', {'fid': 'hidden field', 'PARCEL_PFI': 'hidden field', 'PARCEL_SPI': 'hidden field', 'PC_PLANNO': 'inline label - always visible', 'PC_LOTNO': 'inline label - always visible', 'Gross HA': 'inline label - always visible', 'OBJECTID': 'hidden field', 'LGA': 'inline label - always visible', 'ZONE_CODE': 'inline label - always visible', 'Zone 1 Ha': 'inline label - always visible', 'SAL_NAME21': 'inline label - always visible', 'Address': 'hidden field', 'Address.': 'hidden field', 'fid_2': 'hidden field', 'OBJECTID_2': 'hidden field', 'PROPERTY_PFI': 'hidden field', 'EZI_ADDRESS': 'inline label - always visible', 'PROPERTY_STATUS': 'hidden field', 'BLG_UNIT_TYPE': 'hidden field', 'HSA_FLAG': 'hidden field', 'HSA_UNIT_ID': 'hidden field', 'BLG_UNIT_PREFIX_1': 'hidden field', 'BLG_UNIT_ID_1': 'hidden field', 'BLG_UNIT_SUFFIX_1': 'hidden field', 'BLG_UNIT_PREFIX_2': 'hidden field', 'BLG_UNIT_ID_2': 'hidden field', 'BLG_UNIT_SUFFIX_2': 'hidden field', 'FLOOR_TYPE': 'hidden field', 'FLOOR_PREFIX_1': 'hidden field', 'FLOOR_NO_1': 'hidden field', 'FLOOR_SUFFIX_1': 'hidden field', 'FLOOR_PREFIX_2': 'hidden field', 'FLOOR_NO_2': 'hidden field', 'FLOOR_SUFFIX_2': 'hidden field', 'HOUSE_PREFIX_1': 'hidden field', 'HOUSE_NUMBER_1': 'hidden field', 'HOUSE_SUFFIX_1': 'hidden field', 'HOUSE_PREFIX_2': 'hidden field', 'HOUSE_NUMBER_2': 'hidden field', 'HOUSE_SUFFIX_2': 'hidden field', 'DISP_PREFIX_1': 'hidden field', 'DISP_NUMBER_1': 'hidden field', 'DISP_SUFFIX_1': 'hidden field', 'DISP_PREFIX_2': 'hidden field', 'DISP_NUMBER_2': 'hidden field', 'DISP_SUFFIX_2': 'hidden field', 'ROAD_NAME': 'hidden field', 'ROAD_TYPE': 'hidden field', 'ROAD_SUFFIX': 'hidden field', 'LOCALITY_NAME': 'hidden field', 'LGA_CODE': 'hidden field', 'STATE': 'hidden field', 'POSTCODE': 'hidden field', 'NUM_ROAD_ADDRESS': 'hidden field', 'COMPLEX_SITE': 'hidden field', 'TASK_ID': 'hidden field', 'NDH (ovl)': 'inline label - always visible', 'P_Lot size': 'inline label - always visible', 'Lead Link': 'inline label - always visible', 'Land Owner': 'inline label - always visible', 'Contact no:': 'inline label - always visible', 'Email': 'inline label - always visible', });
lyr_MinersRestTownshipPlan_59.set('fieldLabels', {'id': 'no label', });
lyr_BallaratWestPSPBoundary_60.set('fieldLabels', {'id': 'no label', });
lyr_BallaratNorthPSPBoundary_61.set('fieldLabels', {'id': 'no label', });
lyr_BallaratNorthWesternGrowthArea_62.set('fieldLabels', {'id': 'no label', });
lyr_BallaratNorthWesternGrowthArea_62.on('precompose', function(evt) {
