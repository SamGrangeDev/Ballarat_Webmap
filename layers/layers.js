...
var format_MajorLandOwner_72 = new ol.format.GeoJSON();
var features_MajorLandOwner_72 = format_MajorLandOwner_72.readFeatures(json_MajorLandOwner_72, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MajorLandOwner_72 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MajorLandOwner_72.addFeatures(features_MajorLandOwner_72);
var lyr_MajorLandOwner_72 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MajorLandOwner_72, 
                style: style_MajorLandOwner_72,
                popuplayertitle: "Major Land Owner",
                interactive: false,
                title: '<img src="styles/legend/MajorLandOwner_72.png" /> Major Land Owner'
            });
var format_RezoneParcels_73 = new ol.format.GeoJSON();
var features_RezoneParcels_73 = format_RezoneParcels_73.readFeatures(json_RezoneParcels_73, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RezoneParcels_73 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RezoneParcels_73.addFeatures(features_RezoneParcels_73);
var lyr_RezoneParcels_73 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RezoneParcels_73, 
                style: style_RezoneParcels_73,
                popuplayertitle: "Rezone Parcels",
                interactive: false,
                title: '<img src="styles/legend/RezoneParcels_73.png" /> Rezone Parcels'
            });
var format_ZonedParcels_74 = new ol.format.GeoJSON();
var features_ZonedParcels_74 = format_ZonedParcels_74.readFeatures(json_ZonedParcels_74, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ZonedParcels_74 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ZonedParcels_74.addFeatures(features_ZonedParcels_74);
var lyr_ZonedParcels_74 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ZonedParcels_74, 
                style: style_ZonedParcels_74,
                popuplayertitle: "Zoned Parcels",
                interactive: false,
                title: '<img src="styles/legend/ZonedParcels_74.png" /> Zoned Parcels'
            });
...
var group_Administrative = new ol.layer.Group({
                                layers: [lyr_Suburb_69,lyr_LGA_70,lyr_PropertyBoundaries_71,lyr_MajorLandOwner_72,lyr_RezoneParcels_73,lyr_ZonedParcels_74,lyr_Estate_75,lyr_ParcelAttributes_76,],
                                fold: "open",
...
lyr_ParcelAttributes_76.set('fieldAliases', {'fid': 'fid', 'Parcel:': 'Parcel:', 'Address': 'Address', 'Strategy': 'Strategy', 'Strategy Link': 'Strategy Link', 'Zoned / Rezone': 'Zoned / Rezone', 'Gross HA': 'Gross HA', 'NDH': 'NDH', 'Current Zone': 'Current Zone', 'Overlays': 'Overlays', 'Value:': 'Value:', 'Current RLP': 'Current RLP', 'Current OPC': 'Current OPC', 'Market Value (20%DM)': 'Market Value (20%DM)', 'Market Value (25%DM)': 'Market Value (25%DM)', 'Market Value (30%DM)': 'Market Value (30%DM)', 'Market Value (15%DM)': 'Market Value (15%DM)', 'Lot Yield @ 20Dw/Ha': 'Lot Yield @ 20Dw/Ha', 'Development Contributions per Lot': 'Development Contributions per Lot', 'Last Sold Price': 'Last Sold Price', 'Last Sold Date': 'Last Sold Date', 'Ownership:': 'Ownership:', 'Estate Status': 'Estate Status', 'Developer': 'Developer', 'Vendor Company': 'Vendor Company', 'Vendor Names': 'Vendor Names', 'Vendor Mobiles': 'Vendor Mobiles', 'Vendor Emails': 'Vendor Emails', 'Vendor Addresses': 'Vendor Addresses', 'Major Landowner': 'Major Landowner', 'Lead Link': 'Lead Link', 'Name': 'Name', 'Unique id:': 'Unique id:', 'Unique ID': 'Unique ID', });
...
lyr_ParcelAttributes_76.set('fieldImages', {'fid': '', 'Parcel:': '', 'Address': '', 'Strategy': '', 'Strategy Link': '', 'Zoned / Rezone': '', 'Gross HA': '', 'NDH': '', 'Current Zone': '', 'Overlays': '', 'Value:': '', 'Current RLP': '', 'Current OPC': '', 'Market Value (20%DM)': '', 'Market Value (25%DM)': '', 'Market Value (30%DM)': '', 'Market Value (15%DM)': '', 'Lot Yield @ 20Dw/Ha': '', 'Development Contributions per Lot': '', 'Last Sold Price': '', 'Last Sold Date': '', 'Ownership:': '', 'Estate Status': '', 'Developer': '', 'Vendor Company': '', 'Vendor Names': '', 'Vendor Mobiles': '', 'Vendor Emails': '', 'Vendor Addresses': '', 'Major Landowner': '', 'Lead Link': '', 'Name': '', 'Unique id:': '', 'Unique ID': '', });
...
lyr_ParcelAttributeslabel_78.set('fieldLabels', {'fid': 'hidden field', 'PARCEL': 'header label - always visible', 'Address': 'inline label - visible with data', 'Zoned / Unzoned': 'inline label - visible with data', 'Zoning': 'inline label - visible with data', 'Strategy': 'inline label - visible with data', 'Strategy Link': 'inline label - visible with data', 'Overlays': 'inline label - visible with data', 'Gross(Ha)': 'inline label - visible with data', 'NDH ': 'inline label - visible with data', 'Lot Yield @ 20Dw/Ha': 'inline label - visible with data', 'VALUE': 'header label - always visible', 'Market Value (20%DM)': 'inline label - visible with data', 'Current RLP': 'inline label - visible with data', 'Current OPC': 'inline label - visible with data', 'Market Value (15%DM)': 'inline label - visible with data', 'Market Value (25%DM)': 'inline label - visible with data', 'Market Value (30%DM)': 'inline label - visible with data', 'OWNERSHIP': 'header label - always visible', 'Estate Status': 'inline label - visible with data', 'Developer': 'inline label - visible with data', 'Company': 'inline label - visible with data', 'Directors': 'inline label - visible with data', 'Phone': 'no label', 'Email': 'no label', 'Address:': 'no label', 'Last Sold Price': 'no label', 'Last Sold Date': 'no label', 'Deal Link': 'no label', 'Zoned (Ha)': 'no label', 'OBJECTID': 'no label', 'PROP_PFI': 'no label', 'PROP_LGA_CODE': 'no label', 'Locality': 'no label', '_Name': 'no label', '_Growth Area': 'no label', '_Zoned / Rezone': 'no label', '_Current Zone': 'no label', '_Overlays': 'no label', });
